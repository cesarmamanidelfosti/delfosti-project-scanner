# OpenWiki (contextualicer-open-wiki fork)

> Customized fork of [OpenWiki](https://github.com/langchain-ai/openwiki), adapted to contextualize any project we review. Upstream is tracked via the `upstream` remote for pulling future updates.
